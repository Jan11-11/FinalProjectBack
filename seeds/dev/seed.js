...
async function seed(pg) {
    ...
    await pg('users').insert([
        ...
        },
        {
            ...
            picture:'9345417a-ff94-490c-9bba-cfd61fe1bdc9.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'primeminister',
            status: 'active'
...

        {
            ...
            picture:'ead51cdf-7e3f-40e1-9a18-b086fc73ca42.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
...

        {
            ...
            password: '',
            position: 'ՀՀ փոխվարչապետ',
            picture: 'fd4602d7-b336-478a-956b-6c3ed5e5c7ed.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '9c129079-0431-4fa5-b1af-450dd36809b3.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '75b32f92-9d07-4856-89ca-7cf7bb4cf676.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '9daa832e-6f25-478b-9274-0a41374cf2d1.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '3ed7217f-ab21-4aeb-8c46-3d4098e776f5.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '879e6793-5068-41c8-9fee-e2b06921ccb8.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '812e53a0-e063-4e50-b233-9dca77a64b6c.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: 'ca03ee74-4e66-4ec0-8591-d660aaa08c9d.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '45110aff-c9bb-4885-96b9-e7911a641221.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '78d3d3a6-534e-43a9-9eae-22c736cf0ba3.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '5e720f6d-cbb6-451b-aac5-d326ee527a53.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: 'd9b9238b-ab99-4044-a66f-6d3e54286da3.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '28e2f717-1798-455d-bd26-ad1502b2d1fc.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
        },
        {
            ...
            picture: '0fb889da-7346-4e4b-bf64-4911677f135e.jpg',
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString(),
            role: 'member',
            status: 'active'
